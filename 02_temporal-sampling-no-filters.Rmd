...
# Temporal sampling (no filters)

In this script, we will examine data at the species level for a chosen list of species, across its entire geographic range in the Indian subcontinent. Our aim here is visualize the the distribution of checklists for  
